...
readingMinutes: 5
takeaways:
  - "Casgevy, the first FDA-approved CRISPR therapy, edits the BCL11A gene to reactivate fetal hemoglobin — sickle cell patients are now living symptom-free."
  - "CRISPR fixes disease at the DNA level rather than managing symptoms, fundamentally changing the treatment paradigm for genetic disorders."
  - "The approved therapy costs over $2 million per patient, raising serious access and equity concerns for the populations most affected."
  - "Long-term safety data on off-target effects is still being collected; germline editing remains ethically and legally prohibited."
toc:
  - id: the-breakthrough
