---
title: "The Return of the Woolly Mammoth"
slug: woolly-mammoth-return
date: 2025-03-16
...
readingMinutes: 5
takeaways:
  - "Colossal's \"woolly mice\" prove that cold-adaptation genes from extinct species can be inserted into living animals and expressed as functional traits."
  - "The company's goal is a cold-resistant elephant with mammoth traits by 2028, using edited Asian elephant cells and a surrogate pregnancy."
  - "The ecological case for de-extinction — restoring Arctic grasslands to slow permafrost thaw — is intriguing but unproven at scale."
  - "The gene editing tools being developed have applications far beyond de-extinction, from synthetic biology to embryo manipulation advances."
toc:
  - id: the-breakthrough
    label: "The Breakthrough"
  - id: why-it-matters
    label: "Why It Matters"
  - id: the-counterarguments
    label: "The Counterarguments"
  - id: my-take
    label: "My Take"
related:
